  ...
  return (
    <header className="sticky top-0 z-40 bg-onyx border-b border-champagne/20">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3.5">
        ...
        <div className="hidden md:flex items-center gap-7 text-[13px] text-ivory/75">
          ...
          <div className="relative group">
            ...
            <div className="absolute left-0 top-full hidden group-hover:block bg-onyx-2 border border-champagne/15 shadow-xl w-64 max-h-96 overflow-y-auto">
              {categories.length === 0 ? (
                <div className="px-4 py-3 text-xs text-ivory/40">
                  Belum ada kategori
                </div>
              ) : (
                categories.map((c) => (
          ...
          <Link href="/tentang-kami" className="hover:text-champagne">
            Tentang Kami
          </Link>
        </div>
        ...
        <a
          ...
          target="_blank"
          className="bg-champagne text-onyx text-xs font-medium px-5 py-2.5 hover:bg-champagne-light transition"
        >
          Hubungi Kami
        </a>
      </div>
